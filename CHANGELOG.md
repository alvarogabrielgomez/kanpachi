...
- Say the room is being reopened from the first frame when Kanpachi starts with a room left from the previous run, instead of showing the home screen for the half minute it takes and then jumping to the room
